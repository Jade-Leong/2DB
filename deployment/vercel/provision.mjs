...
for(const item of list){
  ...
  if(item.relative==='control/web/app.js')item.content=Buffer.from(item.content.toString().replaceAll('href="/"','href="/control/"').replaceAll('http://127.0.0.1:3001','/').replaceAll('src="/brand-mark.svg"','src="/control/brand-mark.svg"').replaceAll('Local environment','Vercel-hosted demo'));
}
