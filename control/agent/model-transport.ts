...
export function structuredActionRequest(
  ...
  return JSON.stringify({
    ...
    instructions:
      ...
      "After the controller confirms the edit was saved, submit the proposal for Agent 2 review. Never claim an edit or test succeeded without controller evidence.",
  });
}
